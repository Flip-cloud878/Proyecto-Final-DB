{
  ...
  "cells": [
    ...
    },
    {
      "cell_type": "markdown",
      "source": [
        "siguiendo esta logica logramos extender la tabla de llenado parametrizada para los proyectos en etapa de propuesta hasta el proyecto 62 y se espera completar 100 ejemplos"
      ],
      "metadata": {
        "id": "46QBmRNyGLh4"
      }
    },
    {
      ...
      "source": [
        ...
        "    'Fortalecimiento de las Capacidades de Vigilancia de Metrología Legal',\n",
        "    'Capacitación',\n",
        "    'Convocatoria pública SIC-2024-13',\n",
        "    200000000,\n",
        "    200000000,\n",
        "    '2024-08-21', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        "    NULL, -- No ha habido pagos\n",
        "    'Pendiente de evaluación', -- Condiciones de pago no aplican\n",
        "    200000000,\n",
        "    NULL,\n",
        "    NULL, -- No hay resolución aún\n",
        "    NULL, -- No hay fecha de liquidación\n",
        "    'En propuesta'\n",
        ");\n",
        "\n",
        ...
        "CALL crear_proyecto(\n",
        "    6, -- Instituto Colombiano de Bienestar Familiar (ICBF)\n",
        "    'Fundación Redfamilia',\n",
        "    'Consultoría para Fortalecer la Red de Hogares Comunitarios',\n",
        "    'Consultoría',\n",
        "    'Convocatoria pública ICBF-2024-4',\n",
        "    500000000,\n",
        "    500000000,\n",
        "    '2024-05-23', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Modelo de Predicción Económica con IA para Política Fiscal',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública MHCP-2024-1',\n",
        "    690000000,\n",
        "    690000000,\n",
        "    '2024-11-07', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    5, -- Superintendencia de Industria y Comercio (SIC)\n",
        "    'Universidad del Rosario - Observatorio de la Economía Digital',\n",
        "    'Investigación sobre el Impacto de la Economía Colaborativa en la Competencia de Mercados',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública SIC-2024-7',\n",
        "    260000000,\n",
        "    260000000,\n",
        "    '2024-09-26', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Plan Piloto de Auditorías en Tiempo Real mediante Tecnología Blockchain',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública CGR-2024-13',\n",
        "    590000000,\n",
        "    590000000,\n",
        "    '2024-08-12', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Universidad Externado de Colombia - Departamento de Trabajo Social',\n",
        "    'Investigación Aplicada sobre el Fenómeno de la Migración y su Impacto en la Planificación Local',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública DNP-2024-10',\n",
        "    350000000,\n",
        "    350000000,\n",
        "    '2024-08-01', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Observatorio de Desarrollo Regional Amazónico',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública DNP-2024-11',\n",
        "    300000000,\n",
        "    300000000,\n",
        "    '2024-04-08', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Sistema de Seguimiento de Casos de Desnutrición Aguda en Niños',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública ICBF-2024-9',\n",
        "    300000000,\n",
        "    300000000,\n",
        "    '2024-07-06', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    5, -- Superintendencia de Industria y Comercio (SIC)\n",
        "    'Universidad del Rosario - Escuela de Economía',\n",
        "    'Evaluación de Políticas de Protección al Consumidor Financiero',\n",
        "    'Consultoría',\n",
        "    'Convocatoria pública SIC-2024-11',\n",
        "    100000000,\n",
        "    100000000,\n",
        "    '2024-06-17', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Desarrollo de Plataforma de Denuncias en Línea para Consumidores',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública SIC-2024-10',\n",
        "    355000000,\n",
        "    355000000,\n",
        "    '2024-10-06', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Consultoría',\n",
        "    'Convocatoria pública PRC-2024-2',\n",
        "    250000000,\n",
        "    250000000,\n",
        "    '2024-11-27', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    3, -- Departamento Nacional de Planeación (DNP)\n",
        "    'Consultora Recursos & Regalías',\n",
        "    'Consultoría para la Modernización del Sistema Nacional de Regalías',\n",
        "    'Consultoría',\n",
        "    'Convocatoria pública DNP-2024-12',\n",
        "    600000000,\n",
        "    600000000,\n",
        "    '2024-07-10', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    4, -- Contraloría General de la República\n",
        "    'Consultora Governance S.A.S.',\n",
        "    'Consultoría para la Implementación de Gobierno Corporativo en Empresas Estatales',\n",
        "    'Consultoría',\n",
        "    'Convocatoria pública CGR-2024-9',\n",
        "    300000000,\n",
        "    300000000,\n",
        "    '2024-08-10', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Fortalecimiento de la Cultura Tributaria en Jóvenes',\n",
        "    'Capacitación',\n",
        "    'Convocatoria pública MHCP-2024-13',\n",
        "    200000000,\n",
        "    200000000,\n",
        "    '2024-04-24', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Evaluación de Impacto de Proyectos de Infraestructura Vial',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública DNP-2024-2',\n",
        "    400000000,\n",
        "    400000000,\n",
        "    '2024-04-26', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    6, -- Instituto Colombiano de Bienestar Familiar (ICBF)\n",
        "    'Fundación Crianza Digital',\n",
        "    'Desarrollo de App Educativa para Promover Crianza Positiva',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública ICBF-2024-3',\n",
        "    150000000,\n",
        "    150000000,\n",
        "    '2024-08-16', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Sistema de Información Geográfica para la Planificación Regional',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública DNP-2024-1',\n",
        "    300000000,\n",
        "    300000000,\n",
        "    '2024-09-02', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública CGR-2024-7',\n",
        "    250000000,\n",
        "    250000000,\n",
        "    '2024-05-10', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    5, -- Superintendencia de Industria y Comercio (SIC)\n",
        "    'Universidad Sergio Arboleda - Centro de Investigaciones en Publicidad',\n",
        "    'Implementación de un Observatorio de Publicidad Engañosa',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública SIC-2024-8',\n",
        "    150000000,\n",
        "    150000000,\n",
        "    '2024-07-05', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    4, -- Contraloría General de la República\n",
        "    'Politécnico Colombiano JIC - Facultad de Ingeniería',\n",
        "    'Desarrollo de Plataforma para Seguimiento de Hallazgos Fiscales',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública CGR-2024-5',\n",
        "    800000000,\n",
        "    800000000,\n",
        "    '2024-09-04', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    6, -- Instituto Colombiano de Bienestar Familiar (ICBF)\n",
        "    'Universidad Nacional de Colombia - Escuela de Nutrición y Dietética',\n",
        "    'Programa de Nutrición Infantil en Comunidades Indígenas',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública ICBF-2024-1',\n",
        "    200000000,\n",
        "    200000000,\n",
        "    '2024-04-13', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    2, -- Ministerio de Hacienda y Crédito Público\n",
        "    'Federación Colombiana de Municipios - Unidad de Asistencia Técnica',\n",
        "    'Sistema Integrado de Gestión de Tesorería Territorial',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública MHCP-2024-2',\n",
        "    750000000,\n",
        "    750000000,\n",
        "    '2024-04-21', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Investigación Aplicada sobre Desarrollo Sostenible en Zonas Rurales',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública DNP-2024-3',\n",
        "    300000000,\n",
        "    300000000,\n",
        "    '2024-03-04', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    6, -- Instituto Colombiano de Bienestar Familiar (ICBF)\n",
        "    'Universidad Externado de Colombia - Centro de Investigación en Derechos de la Infancia',\n",
        "    'Observatorio de los Derechos de la Niñez en el Entorno Digital',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública ICBF-2024-11',\n",
        "    400000000,\n",
        "    400000000,\n",
        "    '2024-11-01', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    4, -- Contraloría General de la República\n",
        "    'Universidad del Valle - Facultad de Ciencias Económicas',\n",
        "    'Investigación Aplicada sobre el Impacto del Control Fiscal Preventivo',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública CGR-2024-10',\n",
        "    150000000,\n",
        "    150000000,\n",
        "    '2024-06-05', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    6, -- Instituto Colombiano de Bienestar Familiar (ICBF)\n",
        "    'Universidad de Caldas - Departamento de Sociología',\n",
        "    'Investigación Aplicada sobre Prevención del Trabajo Infantil en Zonas Cafeteras',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública ICBF-2024-2',\n",
        "    550000000,\n",
        "    550000000,\n",
        "    '2024-03-16', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Plataforma de Blockchain para Seguimiento de Recursos Públicos',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria pública MHCP-2024-11',\n",
        "    605000000,\n",
        "    605000000,\n",
        "    '2024-11-16', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Observatorio de la Implementación del Acuerdo de Paz',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública PRC-2024-4',\n",
        "    700000000,\n",
        "    700000000,\n",
        "    '2024-03-28', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    2, -- Ministerio de Hacienda y Crédito Público\n",
        "    'Corporación Desarrollo y Finanzas Municipales',\n",
        "    'Consultoría para Optimización de Recaudo Tributario Municipal',\n",
        "    'Consultoría',\n",
        "    'Convocatoria pública MHCP-2024-14',\n",
        "    100000000,\n",
        "    100000000,\n",
        "    '2024-05-09', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    6, -- Instituto Colombiano de Bienestar Familiar (ICBF)\n",
        "    'Profamilia - Unidad de Investigaciones Sociales',\n",
        "    'Estudio sobre Impacto de Programas de Adolescencia Responsable',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública ICBF-2024-5',\n",
        "    250000000,\n",
        "    250000000,\n",
        "    '2024-03-21', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "CALL crear_proyecto(\n",
        "    6, -- Instituto Colombiano de Bienestar Familiar (ICBF)\n",
        "    'Universidad de La Sabana - Departamento de Psicología',\n",
        "    'Proyecto Piloto de Atención Psicosocial para Niños Víctimas del Conflicto',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública ICBF-2024-7',\n",
        "    300000000,\n",
        "    300000000,\n",
        "    '2024-07-08', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Observatorio Nacional de Innovación Pública',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública PRC-2024-10',\n",
        "    450000000,\n",
        "    450000000,\n",
        "    '2024-06-01', -- Fecha de recepción de propuesta\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha iniciado ejecución\n",
        "    NULL, -- No ha finalizado ejecución\n",
        ...
        "    'Observatorio Nacional de Innovación Pública',\n",
        "    'Investigación aplicada',\n",
        "    'Convocatoria pública PR-2024-10',\n",
        "    450000000,\n",
        "    450000000,\n",
        "    '2024-06-01',\n",
        "    NULL,\n",
        ...
        "    'Facultad de Ingeniería de Sistemas',\n",
        "    'Plataforma de Control Fiscal Automatizado',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria CGR-2024-09',\n",
        "    650000000,\n",
        "    650000000,\n",
        "    '2024-08-15',\n",
        "    NULL,\n",
        ...
        "    'Sistema de Monitoreo Nutricional Infantil',\n",
        "    'Software educativo',\n",
        "    'Convocatoria ICBF-2024-11',\n",
        "    300000000,\n",
        "    300000000,\n",
        "    '2024-09-10',\n",
        "    NULL,\n",
        ...
        "    5, -- SIC\n",
        "    'Facultad de Economía',\n",
        "    'Consultoría en Competencia de Mercados Digitales',\n",
        "    'Consultoría especializada',\n",
        "    'Convocatoria SIC-2024-12',\n",
        "    250000000,\n",
        "    250000000,\n",
        "    '2024-07-05',\n",
        "    NULL,\n",
        ...
        "    'Facultad de Ingeniería Industrial',\n",
        "    'Plataforma Integrada de Gestión Fiscal',\n",
        "    'Implementación tecnológica',\n",
        "    'Convocatoria MHCP-2024-04',\n",
        "    550000000,\n",
        "    550000000,\n",
        "    '2024-06-20',\n",
        "    NULL,\n",
        ...
        "    'Programa de Educación Tributaria Digital',\n",
        "    'Software educativo',\n",
        "    'Convocatoria MHCP-2024-07',\n",
        "    200000000,\n",
        "    200000000,\n",
        "    '2024-05-18',\n",
        "    NULL,\n",
        ...
        ");\n",
        "\n",
        "-- Proyecto 59: Sistema Nacional de Información Territorial\n",
        "CALL crear_proyecto(\n",
        "    3, -- DNP\n",
        "    'Facultad de Geografía',\n",
        "    'Sistema Nacional de Información Territorial',\n",
        "    'Desarrollo GIS',\n",
        "    'Convocatoria DNP-2024-08',\n",
        "    400000000,\n",
        "    400000000,\n",
        "    '2024-08-01',\n",
        "    NULL,\n",
        ...
        "    1, -- Presidencia de la República\n",
        "    'Facultad de Derecho',\n",
        "    'Implementación de Plataforma de Transparencia Pública',\n",
        "    'Desarrollo tecnológico',\n",
        "    'Convocatoria PR-2024-11',\n",
        "    500000000,\n",
        "    500000000,\n",
        "    '2024-09-15',\n",
        "    NULL,\n",
        ...
        "    'Sistema de Atención Integral para la Infancia',\n",
        "    'Servicio social',\n",
        "    'Convocatoria ICBF-2024-13',\n",
        "    350000000,\n",
        "    350000000,\n",
        "    '2024-10-01',\n",
        "    NULL,\n",
        ...
        "    'Observatorio Nacional de Competitividad Económica',\n",
        "    'Investigación económica',\n",
        "    'Convocatoria SIC-2024-14',\n",
        "    250000000,\n",
        "    250000000,\n",
        "    '2024-11-20',\n",
        "    NULL,\n",
        ...
        ");\n",
        "\n",
        "-- Proyectos del 31 al 100 pueden seguir esta estructura con información aleatoria similar.\n"
      ],
      "metadata": {
        "id": "1X5Wr6gpGbaw"
      },
