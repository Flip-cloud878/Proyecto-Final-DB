  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "2db0ab8d-8ce0-49ab-ed88-86b7ceb4a4f1"
      },
      "execution_count": null,
      "outputs": [
        {
          "output_type": "error",
          "ename": "SyntaxError",
          "evalue": "invalid syntax (<ipython-input-11-d9417ede3368>, line 1)",
          "traceback": [
            "\u001b[0;36m  File \u001b[0;32m\"<ipython-input-11-d9417ede3368>\"\u001b[0;36m, line \u001b[0;32m1\u001b[0m\n\u001b[0;31m    -- Proyecto 6: Sistema Nacional de Seguridad Vial\u001b[0m\n\u001b[0m                ^\u001b[0m\n\u001b[0;31mSyntaxError\u001b[0m\u001b[0;31m:\u001b[0m invalid syntax\n"
          ]
        }
      ]
    },
    {
      "cell_type": "markdown",
      "source": [
        "siguiendo esta logica logramos extender la tabla de llenado parametrizada para los proyectos en etapa de propuesta hasta el proyecto 21 hasta el 100"
      ],
      "metadata": {
        "id": "46QBmRNyGLh4"
      }
    },
    {
      "cell_type": "code",
      "source": [
        "-- Proyecto 21: Fortalecimiento de las Capacidades de Vigilancia de Metrología Legal\n",
        "CALL crear_proyecto(5, 'Instituto Nacional de Metrología (INM)','Fortalecimiento de las Capacidades de Vigilancia de Metrología Legal','Capacitación','Convocatoria pública SIC-2024-13',200000000,200000000,'2024-08-21',NULL, NULL, NULL, NULL, NULL, 200000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 22: Consultoría para Fortalecer la Red de Hogares Comunitarios\n",
        "CALL crear_proyecto(6, 'Fundación Redfamilia','Consultoría para Fortalecer la Red de Hogares Comunitarios','Consultoría','Convocatoria pública ICBF-2024-4',500000000,500000000,'2024-05-23',NULL, NULL, NULL, NULL, NULL,  500000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 23: Modelo de Predicción Económica con IA para Política Fiscal\n",
        "CALL crear_proyecto(2, 'Universidad Nacional de Colombia - Departamento de Economía','Modelo de Predicción Económica con IA para Política Fiscal','Desarrollo tecnológico','Convocatoria pública MHCP-2024-1',690000000,690000000,'2024-11-07',NULL, NULL, NULL, NULL, NULL,  690000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 24: Investigación sobre el Impacto de la Economía Colaborativa en la Competencia de Mercados\n",
        "CALL crear_proyecto(5, 'Universidad del Rosario - Observatorio de la Economía Digital','Investigación sobre el Impacto de la Economía Colaborativa en la Competencia de Mercados','Investigación aplicada','Convocatoria pública SIC-2024-7',260000000,260000000,'2024-09-26',NULL, NULL, NULL, NULL, NULL,  260000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 25: Plan Piloto de Auditorías en Tiempo Real mediante Tecnología Blockchain\n",
        "CALL crear_proyecto(4, 'Universidad de los Andes - Departamento de Ingeniería de Sistemas','Plan Piloto de Auditorías en Tiempo Real mediante Tecnología Blockchain','Desarrollo tecnológico','Convocatoria pública CGR-2024-13',590000000,590000000,'2024-08-12',NULL, NULL, NULL, NULL, NULL,  590000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 26: Investigación Aplicada sobre el Fenómeno de la Migración y su Impacto en la Planificación Local\n",
        "CALL crear_proyecto(3, 'Universidad Externado de Colombia - Departamento de Trabajo Social','Investigación Aplicada sobre el Fenómeno de la Migración y su Impacto en la Planificación Local','Investigación aplicada','Convocatoria pública DNP-2024-10',350000000,350000000,'2024-08-01',NULL, NULL, NULL, NULL, NULL,  350000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 27: Observatorio de Desarrollo Regional Amazónico\n",
        "CALL crear_proyecto(3, 'Instituto Amazónico de Investigaciones Científicas (SINCHI)','Observatorio de Desarrollo Regional Amazónico','Investigación aplicada','Convocatoria pública DNP-2024-11',300000000,300000000,'2024-04-08',NULL, NULL, NULL, NULL, NULL,  300000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 28: Sistema de Seguimiento de Casos de Desnutrición Aguda en Niños\n",
        "CALL crear_proyecto(6, 'Universidad del Valle - Escuela de Salud Pública','Sistema de Seguimiento de Casos de Desnutrición Aguda en Niños','Desarrollo tecnológico','Convocatoria pública ICBF-2024-9',300000000,300000000,'2024-07-06',NULL, NULL, NULL, NULL, NULL,  300000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 29: Evaluación de Políticas de Protección al Consumidor Financiero\n",
        "CALL crear_proyecto(5, 'Universidad del Rosario - Escuela de Economía','Evaluación de Políticas de Protección al Consumidor Financiero','Consultoría','Convocatoria pública SIC-2024-11',100000000,100000000,'2024-06-17',NULL, NULL, NULL, NULL, NULL,  100000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 30: Desarrollo de Plataforma de Denuncias en Línea para Consumidores\n",
        "CALL crear_proyecto(5, 'Universidad del Cauca - Departamento de Telemática','Desarrollo de Plataforma de Denuncias en Línea para Consumidores','Desarrollo tecnológico','Convocatoria pública SIC-2024-10',355000000,355000000,'2024-10-06',NULL, NULL, NULL, NULL, NULL,  355000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 31: Estrategia Nacional de Ciberseguridad Ciudadana\n",
        "CALL crear_proyecto(1, 'Universidad de los Andes - Departamento de Ingeniería de Sistemas','Estrategia Nacional de Ciberseguridad Ciudadana','Consultoría','Convocatoria pública PRC-2024-2',250000000,250000000,'2024-11-27',NULL, NULL, NULL, NULL, NULL,  250000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 32: Consultoría para la Modernización del Sistema Nacional de Regalías\n",
        "CALL crear_proyecto(3, 'Consultora Recursos & Regalías','Consultoría para la Modernización del Sistema Nacional de Regalías','Consultoría','Convocatoria pública DNP-2024-12',600000000,600000000,'2024-07-10',NULL, NULL, NULL, NULL, NULL,  600000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 33: Consultoría para la Implementación de Gobierno Corporativo en Empresas Estatales\n",
        "CALL crear_proyecto(4, 'Consultora Governance S.A.S.','Consultoría para la Implementación de Gobierno Corporativo en Empresas Estatales','Consultoría','Convocatoria pública CGR-2024-9',300000000,300000000,'2024-08-10',NULL, NULL, NULL, NULL, NULL,  300000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 34: Fortalecimiento de la Cultura Tributaria en Jóvenes\n",
        "CALL crear_proyecto(2, 'Fundación Educación y Desarrollo','Fortalecimiento de la Cultura Tributaria en Jóvenes','Capacitación','Convocatoria pública MHCP-2024-13',200000000,200000000,'2024-04-24',NULL, NULL, NULL, NULL, NULL,  200000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 35: Evaluación de Impacto de Proyectos de Infraestructura Vial\n",
        "CALL crear_proyecto(3, 'Universidad de los Andes - CEDE','Evaluación de Impacto de Proyectos de Infraestructura Vial','Investigación aplicada','Convocatoria pública DNP-2024-2',400000000,400000000,'2024-04-26',NULL, NULL, NULL, NULL, NULL,  400000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 36: Desarrollo de App Educativa para Promover Crianza Positiva\n",
        "CALL crear_proyecto(6, 'Fundación Crianza Digital','Desarrollo de App Educativa para Promover Crianza Positiva','Desarrollo tecnológico','Convocatoria pública ICBF-2024-3',150000000,150000000,'2024-08-16',NULL, NULL, NULL, NULL, NULL,  150000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 37: Sistema de Información Geográfica para la Planificación Regional\n",
        "CALL crear_proyecto(3, 'Instituto Geográfico Agustín Codazzi (IGAC)','Sistema de Información Geográfica para la Planificación Regional','Desarrollo tecnológico','Convocatoria pública DNP-2024-1', 300000000,300000000,'2024-09-02',NULL, NULL, NULL, NULL, NULL,  300000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 38: Observatorio Ciudadano de Transparencia Fiscal\n",
        "CALL crear_proyecto(4, 'Red de Veedurías Ciudadanas','Observatorio Ciudadano de Transparencia Fiscal','Investigación aplicada','Convocatoria pública CGR-2024-7',250000000,250000000,'2024-05-10',NULL, NULL, NULL, NULL, NULL,  250000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 39: Implementación de un Observatorio de Publicidad Engañosa\n",
        "CALL crear_proyecto(5, 'Universidad Sergio Arboleda - Centro de Investigaciones en Publicidad','Implementación de un Observatorio de Publicidad Engañosa','Investigación aplicada','Convocatoria pública SIC-2024-8',150000000,150000000,'2024-07-05',NULL, NULL, NULL, NULL, NULL,  150000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 40: Desarrollo de Plataforma para Seguimiento de Hallazgos Fiscales\n",
        "CALL crear_proyecto(4, 'Politécnico Colombiano JIC - Facultad de Ingeniería','Desarrollo de Plataforma para Seguimiento de Hallazgos Fiscales','Desarrollo tecnológico','Convocatoria pública CGR-2024-5',800000000,800000000,'2024-09-04',NULL, NULL, NULL, NULL, NULL,  800000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 41: Programa de Nutrición Infantil en Comunidades Indígenas\n",
        "CALL crear_proyecto(6, 'Universidad Nacional de Colombia - Escuela de Nutrición y Dietética','Programa de Nutrición Infantil en Comunidades Indígenas','Investigación aplicada','Convocatoria pública ICBF-2024-1',200000000,200000000,'2024-04-13',NULL, NULL, NULL, NULL, NULL,  200000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 42: Sistema Integrado de Gestión de Tesorería Territorial\n",
        "CALL crear_proyecto(2, 'Federación Colombiana de Municipios - Unidad de Asistencia Técnica','Sistema Integrado de Gestión de Tesorería Territorial','Desarrollo tecnológico','Convocatoria pública MHCP-2024-2',750000000,750000000,'2024-04-21',NULL, NULL, NULL, NULL, NULL,  750000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 43: Investigación Aplicada sobre Desarrollo Sostenible en Zonas Rurales\n",
        "CALL crear_proyecto(3, 'Universidad del Cauca - Facultad de Ciencias Agrarias','Investigación Aplicada sobre Desarrollo Sostenible en Zonas Rurales','Investigación aplicada','Convocatoria pública DNP-2024-3',300000000,300000000,'2024-03-04',NULL, NULL, NULL, NULL, NULL,  300000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 44: Observatorio de los Derechos de la Niñez en el Entorno Digital\n",
        "CALL crear_proyecto(6, 'Universidad Externado de Colombia - Centro de Investigación en Derechos de la Infancia','Observatorio de los Derechos de la Niñez en el Entorno Digital','Investigación aplicada','Convocatoria pública ICBF-2024-11',400000000,400000000,'2024-11-01',NULL, NULL, NULL, NULL, NULL,400000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 45: Investigación Aplicada sobre el Impacto del Control Fiscal Preventivo\n",
        "CALL crear_proyecto(4, 'Universidad del Valle - Facultad de Ciencias Económicas','Investigación Aplicada sobre el Impacto del Control Fiscal Preventivo','Investigación aplicada','Convocatoria pública CGR-2024-10',150000000,150000000,'2024-06-05',NULL, NULL, NULL, NULL, NULL,  150000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 46: Investigación Aplicada sobre Prevención del Trabajo Infantil en Zonas Cafeteras\n",
        "CALL crear_proyecto(6, 'Universidad de Caldas - Departamento de Sociología','Investigación Aplicada sobre Prevención del Trabajo Infantil en Zonas Cafeteras','Investigación aplicada','Convocatoria pública ICBF-2024-2',550000000,550000000,'2024-03-16',NULL, NULL, NULL, NULL, NULL,  550000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 47: Plataforma de Blockchain para Seguimiento de Recursos Públicos\n",
        "CALL crear_proyecto(2, 'Universidad Nacional de Colombia - Departamento de Ingeniería de Sistemas','Plataforma de Blockchain para Seguimiento de Recursos Públicos','Desarrollo tecnológico','Convocatoria pública MHCP-2024-11',605000000,605000000,'2024-11-16',NULL, NULL, NULL, NULL, NULL,  605000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 48: Observatorio de la Implementación del Acuerdo de Paz\n",
        "CALL crear_proyecto(1, 'Universidad Nacional de Colombia - Instituto de Estudios Políticos y Relaciones Internacionales','Observatorio de la Implementación del Acuerdo de Paz','Investigación aplicada','Convocatoria pública PRC-2024-4',700000000,700000000,'2024-03-28',NULL, NULL, NULL, NULL, NULL,  700000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 49: Consultoría para Optimización de Recaudo Tributario Municipal\n",
        "CALL crear_proyecto(2, 'Corporación Desarrollo y Finanzas Municipales','Consultoría para Optimización de Recaudo Tributario Municipal','Consultoría','Convocatoria pública MHCP-2024-14',100000000,100000000,'2024-05-09',NULL, NULL, NULL, NULL, NULL,  100000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 50: Estudio sobre Impacto de Programas de Adolescencia Responsable\n",
        "CALL crear_proyecto(6, 'Profamilia - Unidad de Investigaciones Sociales','Estudio sobre Impacto de Programas de Adolescencia Responsable','Investigación aplicada','Convocatoria pública ICBF-2024-5',250000000,250000000,'2024-03-21',NULL, NULL, NULL, NULL, NULL,  250000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 51: Proyecto Piloto de Atención Psicosocial para Niños Víctimas del Conflicto\n",
        "CALL crear_proyecto(6, 'Universidad de La Sabana - Departamento de Psicología','Proyecto Piloto de Atención Psicosocial para Niños Víctimas del Conflicto','Investigación aplicada','Convocatoria pública ICBF-2024-7',300000000,300000000,'2024-07-08',NULL, NULL, NULL, NULL, NULL,  300000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 52: Observatorio Ciudadano de Innovación Pública (Ejemplo)\n",
        "CALL crear_proyecto(1, 'Facultad de Administración Pública','Observatorio Nacional de Innovación Pública','Investigación aplicada','Convocatoria pública PRC-2024-10',450000000,450000000,'2024-06-01',NULL, NULL, NULL, NULL, NULL,  450000000,NULL,NULL, NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 53: Observatorio Nacional de Innovación Pública\n",
        "CALL crear_proyecto(1, 'Facultad de Administración Pública','Observatorio Nacional de Innovación Pública','Investigación aplicada','Convocatoria pública PR-2024-10',450000000,450000000,'2024-06-01',NULL, NULL, NULL, NULL, NULL, 450000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 54: Plataforma de Control Fiscal Automatizado\n",
        "CALL crear_proyecto(4, 'Facultad de Ingeniería de Sistemas','Plataforma de Control Fiscal Automatizado','Desarrollo tecnológico','Convocatoria CGR-2024-09',650000000,650000000,'2024-08-15',NULL,NULL,NULL,NULL,NULL,650000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 55: Sistema de Monitoreo Nutricional Infantil\n",
        "CALL crear_proyecto(6, 'Facultad de Salud Pública','Sistema de Monitoreo Nutricional Infantil','Software educativo','Convocatoria ICBF-2024-11',300000000,300000000,'2024-09-10',NULL,NULL,NULL,NULL,NULL,300000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 56: Consultoría en Competencia de Mercados Digitales\n",
        "CALL crear_proyecto(5, 'Facultad de Economía','Consultoría en Competencia de Mercados Digitales','Consultoría especializada','Convocatoria SIC-2024-12',250000000,250000000,'2024-07-05',NULL,NULL,NULL,NULL,NULL,250000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 57: Plataforma Integrada de Gestión Fiscal\n",
        "CALL crear_proyecto(2, 'Facultad de Ingeniería Industrial','Plataforma Integrada de Gestión Fiscal','Implementación tecnológica','Convocatoria MHCP-2024-04',550000000,550000000,'2024-06-20',NULL,NULL,NULL,NULL,NULL,550000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 58: Programa de Educación Tributaria Digital\n",
        "CALL crear_proyecto(2, 'Facultad de Educación','Programa de Educación Tributaria Digital','Software educativo','Convocatoria MHCP-2024-07',200000000,200000000,'2024-05-18',NULL,NULL,NULL,NULL,NULL,200000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 59: Sistema Nacional de Información TerritorialCALL crear_proyecto(3, -- DNP'Facultad de Geografía','Sistema Nacional de Información Territorial','Desarrollo GIS','Convocatoria DNP-2024-08',400000000,400000000,'2024-08-01',NULL,NULL,NULL,NULL,NULL,400000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 60: Implementación de Plataforma de Transparencia Pública\n",
        "CALL crear_proyecto(1, 'Facultad de Derecho','Implementación de Plataforma de Transparencia Pública','Desarrollo tecnológico','Convocatoria PR-2024-11',500000000,500000000,'2024-09-15',NULL,NULL,NULL,NULL,NULL,500000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 61: Sistema de Atención Integral para la Infancia\n",
        "CALL crear_proyecto(6, 'Facultad de Psicología','Sistema de Atención Integral para la Infancia','Servicio social','Convocatoria ICBF-2024-13',350000000,350000000,'2024-10-01',NULL,NULL,NULL,NULL,NULL,350000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "-- Proyecto 62: Observatorio Nacional de Competitividad Económica\n",
        "CALL crear_proyecto(5, 'Facultad de Ciencias Económicas','Observatorio Nacional de Competitividad Económica','Investigación económica','Convocatoria SIC-2024-14',250000000,250000000,'2024-11-20',NULL,NULL,NULL,NULL,NULL,250000000,NULL,NULL,NULL,'En propuesta');\n",
        "\n",
        "\n",
        "CALL crear_proyecto( 5, 'Instituto Nacional de Metrología (INM)', 'Fortalecimiento de las Capacidades de Vigilancia de Metrología Legal', 'Capacitación', 'Convocatoria pública SIC-2024-13', 200000000, 200000000, '2024-08-21', NULL, NULL, NULL, NULL,  200000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Fundación Redfamilia', 'Consultoría para Fortalecer la Red de Hogares Comunitarios', 'Consultoría', 'Convocatoria pública ICBF-2024-4', 500000000, 500000000, '2024-05-23', NULL, NULL, NULL, NULL,  500000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 2, 'Universidad Nacional de Colombia - Departamento de Economía', 'Modelo de Predicción Económica con IA para Política Fiscal', 'Desarrollo tecnológico', 'Convocatoria pública MHCP-2024-1', 690000000, 690000000, '2024-11-07', NULL, NULL, NULL, NULL,  690000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 5, 'Universidad del Rosario - Observatorio de la Economía Digital', 'Investigación sobre el Impacto de la Economía Colaborativa en la Competencia de Mercados', 'Investigación aplicada', 'Convocatoria pública SIC-2024-7', 260000000, 260000000, '2024-09-26', NULL, NULL, NULL, NULL,  260000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 4, 'Universidad de los Andes - Departamento de Ingeniería de Sistemas', 'Plan Piloto de Auditorías en Tiempo Real mediante Tecnología Blockchain', 'Desarrollo tecnológico', 'Convocatoria pública CGR-2024-13', 590000000, 590000000, '2024-08-12', NULL, NULL, NULL, NULL,  590000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 3, 'Universidad Externado de Colombia - Departamento de Trabajo Social', 'Investigación Aplicada sobre el Fenómeno de la Migración y su Impacto en la Planificación Local', 'Investigación aplicada', 'Convocatoria pública DNP-2024-10', 350000000, 350000000, '2024-08-01', NULL, NULL, NULL, NULL,  350000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 3, 'Instituto Amazónico de Investigaciones Científicas (SINCHI)', 'Observatorio de Desarrollo Regional Amazónico', 'Investigación aplicada', 'Convocatoria pública DNP-2024-11', 300000000, 300000000, '2024-04-08', NULL, NULL, NULL, NULL,  300000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Universidad del Valle - Escuela de Salud Pública', 'Sistema de Seguimiento de Casos de Desnutrición Aguda en Niños', 'Desarrollo tecnológico', 'Convocatoria pública ICBF-2024-9', 300000000, 300000000, '2024-07-06', NULL, NULL, NULL, NULL,  300000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 5, 'Universidad del Rosario - Escuela de Economía', 'Evaluación de Políticas de Protección al Consumidor Financiero', 'Consultoría', 'Convocatoria pública SIC-2024-11', 100000000, 100000000, '2024-06-17', NULL, NULL, NULL, NULL,  100000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 5, 'Universidad del Cauca - Departamento de Telemática', 'Desarrollo de Plataforma de Denuncias en Línea para Consumidores', 'Desarrollo tecnológico', 'Convocatoria pública SIC-2024-10', 355000000, 355000000, '2024-10-06', NULL, NULL, NULL, NULL,  355000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 1, 'Universidad de los Andes - Departamento de Ingeniería de Sistemas', 'Estrategia Nacional de Ciberseguridad Ciudadana', 'Consultoría', 'Convocatoria pública PRC-2024-2', 250000000, 250000000, '2024-11-27', NULL, NULL, NULL, NULL,  250000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 3, 'Consultora Recursos & Regalías', 'Consultoría para la Modernización del Sistema Nacional de Regalías', 'Consultoría', 'Convocatoria pública DNP-2024-12', 600000000, 600000000, '2024-07-10', NULL, NULL, NULL, NULL,  600000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 4, 'Consultora Governance S.A.S.', 'Consultoría para la Implementación de Gobierno Corporativo en Empresas Estatales', 'Consultoría', 'Convocatoria pública CGR-2024-9', 300000000, 300000000, '2024-08-10', NULL, NULL, NULL, NULL,  300000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 2, 'Fundación Educación y Desarrollo', 'Fortalecimiento de la Cultura Tributaria en Jóvenes', 'Capacitación', 'Convocatoria pública MHCP-2024-13', 200000000, 200000000, '2024-04-24', NULL, NULL, NULL, NULL,  200000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 3, 'Universidad de los Andes - CEDE', 'Evaluación de Impacto de Proyectos de Infraestructura Vial', 'Investigación aplicada', 'Convocatoria pública DNP-2024-2', 400000000, 400000000, '2024-04-26', NULL, NULL, NULL, NULL,  400000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Fundación Crianza Digital', 'Desarrollo de App Educativa para Promover Crianza Positiva', 'Desarrollo tecnológico', 'Convocatoria pública ICBF-2024-3', 150000000, 150000000, '2024-08-16', NULL, NULL, NULL, NULL,  150000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 3, 'Instituto Geográfico Agustín Codazzi (IGAC)', 'Sistema de Información Geográfica para la Planificación Regional', 'Desarrollo tecnológico', 'Convocatoria pública DNP-2024-1', 300000000, 300000000, '2024-09-02', NULL, NULL, NULL, NULL,  300000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 4, 'Red de Veedurías Ciudadanas', 'Observatorio Ciudadano de Transparencia Fiscal', 'Investigación aplicada', 'Convocatoria pública CGR-2024-7', 250000000, 250000000, '2024-05-10', NULL, NULL, NULL, NULL,  250000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 5, 'Universidad Sergio Arboleda - Centro de Investigaciones en Publicidad', 'Implementación de un Observatorio de Publicidad Engañosa', 'Investigación aplicada', 'Convocatoria pública SIC-2024-8', 150000000, 150000000, '2024-07-05', NULL, NULL, NULL, NULL,  150000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 4, 'Politécnico Colombiano JIC - Facultad de Ingeniería', 'Desarrollo de Plataforma para Seguimiento de Hallazgos Fiscales', 'Desarrollo tecnológico', 'Convocatoria pública CGR-2024-5', 800000000, 800000000, '2024-09-04', NULL, NULL, NULL, NULL,  800000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Universidad Nacional de Colombia - Escuela de Nutrición y Dietética', 'Programa de Nutrición Infantil en Comunidades Indígenas', 'Investigación aplicada', 'Convocatoria pública ICBF-2024-1', 200000000, 200000000, '2024-04-13', NULL, NULL, NULL, NULL,  200000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 2, 'Federación Colombiana de Municipios - Unidad de Asistencia Técnica', 'Sistema Integrado de Gestión de Tesorería Territorial', 'Desarrollo tecnológico', 'Convocatoria pública MHCP-2024-2', 750000000, 750000000, '2024-04-21', NULL, NULL, NULL, NULL,  750000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 3, 'Universidad del Cauca - Facultad de Ciencias Agrarias', 'Investigación Aplicada sobre Desarrollo Sostenible en Zonas Rurales', 'Investigación aplicada', 'Convocatoria pública DNP-2024-3', 300000000, 300000000, '2024-03-04', NULL, NULL, NULL, NULL,  300000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Universidad Externado de Colombia - Centro de Investigación en Derechos de la Infancia', 'Observatorio de los Derechos de la Niñez en el Entorno Digital', 'Investigación aplicada', 'Convocatoria pública ICBF-2024-11', 400000000, 400000000, '2024-11-01', NULL, NULL, NULL, NULL,  400000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 4, 'Universidad del Valle - Facultad de Ciencias Económicas', 'Investigación Aplicada sobre el Impacto del Control Fiscal Preventivo', 'Investigación aplicada', 'Convocatoria pública CGR-2024-10', 150000000, 150000000, '2024-06-05', NULL, NULL, NULL, NULL,  150000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Universidad de Caldas - Departamento de Sociología', 'Investigación Aplicada sobre Prevención del Trabajo Infantil en Zonas Cafeteras', 'Investigación aplicada', 'Convocatoria pública ICBF-2024-2', 550000000, 550000000, '2024-03-16', NULL, NULL, NULL, NULL,  550000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 2, 'Universidad Nacional de Colombia - Departamento de Ingeniería de Sistemas', 'Plataforma de Blockchain para Seguimiento de Recursos Públicos', 'Desarrollo tecnológico', 'Convocatoria pública MHCP-2024-11', 605000000, 605000000, '2024-11-16', NULL, NULL, NULL, NULL,  605000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 1, 'Universidad Nacional de Colombia - Instituto de Estudios Políticos y Relaciones Internacionales', 'Observatorio de la Implementación del Acuerdo de Paz', 'Investigación aplicada', 'Convocatoria pública PRC-2024-4', 700000000, 700000000, '2024-03-28', NULL, NULL, NULL, NULL,  700000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 2, 'Corporación Desarrollo y Finanzas Municipales', 'Consultoría para Optimización de Recaudo Tributario Municipal', 'Consultoría', 'Convocatoria pública MHCP-2024-14', 100000000, 100000000, '2024-05-09', NULL, NULL, NULL, NULL,  100000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Profamilia - Unidad de Investigaciones Sociales', 'Estudio sobre Impacto de Programas de Adolescencia Responsable', 'Investigación aplicada', 'Convocatoria pública ICBF-2024-5', 250000000, 250000000, '2024-03-21', NULL, NULL, NULL, NULL,  250000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Universidad de La Sabana - Departamento de Psicología', 'Proyecto Piloto de Atención Psicosocial para Niños Víctimas del Conflicto', 'Investigación aplicada', 'Convocatoria pública ICBF-2024-7', 300000000, 300000000, '2024-07-08', NULL, NULL, NULL, NULL,  300000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 1, 'Facultad de Administración Pública', 'Observatorio Nacional de Innovación Pública', 'Investigación aplicada', 'Convocatoria pública PRC-2024-10', 450000000, 450000000, '2024-06-01', NULL, NULL, NULL, NULL,  450000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 1, 'Facultad de Administración Pública', 'Observatorio Nacional de Innovación Pública', 'Investigación aplicada', 'Convocatoria pública PR-2024-10', 450000000, 450000000, '2024-06-01', NULL, NULL, NULL, NULL,  450000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 4, 'Facultad de Ingeniería de Sistemas', 'Plataforma de Control Fiscal Automatizado', 'Desarrollo tecnológico', 'Convocatoria CGR-2024-09', 650000000, 650000000, '2024-08-15', NULL, NULL, NULL, NULL, 650000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Facultad de Salud Pública', 'Sistema de Monitoreo Nutricional Infantil', 'Software educativo', 'Convocatoria ICBF-2024-11', 300000000, 300000000, '2024-09-10', NULL, NULL, NULL, NULL, 300000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 5, 'Facultad de Economía', 'Consultoría en Competencia de Mercados Digitales', 'Consultoría especializada', 'Convocatoria SIC-2024-12', 250000000, 250000000, '2024-07-05', NULL, NULL, NULL, NULL, 250000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 2, 'Facultad de Ingeniería Industrial', 'Plataforma Integrada de Gestión Fiscal', 'Implementación tecnológica', 'Convocatoria MHCP-2024-04', 550000000, 550000000, '2024-06-20', NULL, NULL, NULL, NULL, 550000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 2, 'Facultad de Educación', 'Programa de Educación Tributaria Digital', 'Software educativo', 'Convocatoria MHCP-2024-07', 200000000, 200000000, '2024-05-18', NULL, NULL, NULL, NULL, 200000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 3, 'Facultad de Geografía', 'Sistema Nacional de Información Territorial', 'Desarrollo GIS', 'Convocatoria DNP-2024-08', 400000000, 400000000, '2024-08-01', NULL, NULL, NULL, NULL, 400000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 1, 'Facultad de Derecho', 'Implementación de Plataforma de Transparencia Pública', 'Desarrollo tecnológico', 'Convocatoria PR-2024-11', 500000000, 500000000, '2024-09-15', NULL, NULL, NULL, NULL, 500000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 6, 'Facultad de Psicología', 'Sistema de Atención Integral para la Infancia', 'Servicio social', 'Convocatoria ICBF-2024-13', 350000000, 350000000, '2024-10-01', NULL, NULL, NULL, NULL, 350000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n",
        "CALL crear_proyecto( 5, 'Facultad de Ciencias Económicas', 'Observatorio Nacional de Competitividad Económica', 'Investigación económica', 'Convocatoria SIC-2024-14', 250000000, 250000000, '2024-11-20', NULL, NULL, NULL, NULL, 250000000, NULL, NULL, NULL, NULL, 'En propuesta' );\n"
      ],
      "metadata": {
        "id": "1X5Wr6gpGbaw"
      },
